...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <center>
      <table width="500" border="0" cellpadding="0" cellspacing="0" style="font-family: Arial, Verdana, sans-serif; text-align: center;">
	<!-- BEGIN HEADER -->
	...
	<tr>
          ...
          {/if}
          <td colspan="1"></td>
          <td style = "padding-left:88px;"><font size="1" align="right">{$invoice_date|crmDate}</font></td>  
	</tr>
	...
	<tr>
          <td colspan="2" {$valueStyle}>
            <table>
              <tr>
                <th style = "padding-right:30px;"><center><b><font size="2" align="center">Description</font></b></center></th>
                <th style = "padding-left:30px;"><center><b><font size="2" align="center">Quantity</font> </b></center></th>
                <th style = "padding-left:30px;"><center><b><font size="2" align="center">Unit Price</font></b></center></th>
                <th style = "padding-left:33px;"><center><b><font size="2" align="center">VAT </font></b></center></th>
                <th style = "padding-left:30px;"><center><b><font size="2" align="center">Amount GBP</font></b></center></th>
              </tr>
		 ...
		 {elseif $value.tax_rate == 0}
		  <td style = "padding-left:52px;"><center><font size="1" align="center">VAT Exempt</font></center></td>
		 {else}
		  <td style = "padding-left:52px;"><center><font size="1" align="center"></font></center></td>
		 {/if}
		...
		<td style = "padding-left:52px;"><font size="1" align="center"> {$subTotal|crmMoney:$currency}</font></td>
		 ...
		 {elseif  $priceset == 0}
		  ...
		  <td style = "padding-left:52px;"><font size="1" align="right">$0.00</font> </td>
	       </tr>
	         {/if}
	      {/foreach}
		...
		<td colspan ="2"><hr></hr></td>
	      ...
	      <tr>
		<td colspan="3"></td>
		<td style = "padding-left:52px;"><b><font size="1" align="right">TOTAL GBP</font></b></td>
		...
		{if $contribution_status_id == $contributionStatusId}
		 <td ></td>
		{else}
		 <td ><b><font size="1" align="center">DUE DATE:  {$dueDate|crmDate}</font></b></td>
		{/if}
		<td colspan="3"></td>
	      </tr>
            </table>
	 ...
	 <tr>
      ...
      {else}
	   ...
	   <td><b><font size="4" align="right">PAYMENT ADVICE</font><b/> <br/><br/> <b><font size="1" align="right">To:            
		...
		<tr>
		<td colspan="5" style = "color:#F5F5F5;"><hr></hr></td></tr>
		 {if $is_pay_later == 1}
	          <tr>
	           <td colspan="2"></td>
		 ...
		 {/if}
		  <tr>
		   ...
		   <td><font size="1" align="right">{$dueDate|crmDate}</font></td>
		  </tr>
		  <tr>
		   <td colspan="5" style = "color:#F5F5F5;"><hr></hr></td>
		  </tr>
