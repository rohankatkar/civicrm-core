 ...
 * contacts.
 */
class CRM_Contribute_Form_Task_PDFInvoice extends CRM_Contribute_Form_Task {
   /**
...
AND    {$this->_componentClause}";
  ...
  public function postProcess() {
    ...
    if ($createPdf) {
      CRM_Utils_PDF_Utils::html2pdf($messageInvoice, 'civicrmContributionInvoice.pdf', FALSE);
